...
public class Common {
	...
	public static void Switch_Window(String parentWindow,WebDriver driver) {
	...
	public static void logStatus(String Status) {
		...
		if (Status.equalsIgnoreCase("Pass")) {
			log("<Strong><font color=#008000>Pass</font></strong></br>");
		} else if (Status.equalsIgnoreCase("Fail")) {
			log("<Strong><font color=#FF0000>Fail</font></strong></br>");
		}
...
System.out.println("***********************");
	 ...
	 * @param value
	 */
	public static String SelectedTextOption="";
	public static void selectFromCombo(WebElement element, String value) {
		...
		SelectedTextOption = option.getText();
	}
	...
	public static void selectFromComboByVisibleText(WebElement element,
		...
		SelectedTextOption = option.get(0).getText();
	/*	WebElement option = select.getFirstSelectedOption();
		SelectedTextOption = option.getText();*/
	}

	
	public static void selectFromComboIndex(WebElement element, int value) {
	...
	private void simulateDragAndDrop(WebDriver driver,WebElement elementToDrag,
	...
	//COMMON METHOD FOR AUSTRALLIAN AP****************************************
